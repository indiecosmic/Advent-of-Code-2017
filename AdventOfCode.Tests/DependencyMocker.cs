...
namespace AdventOfCode.Tests
{
    ...
    public abstract class DependencyMockerBase
    {
        protected abstract object InterfaceBuilder(Type type);

        internal T New<T>(dynamic ctorParams = null, int ctorIndex = 0)
        {
        ...
        Dictionary<string, object> ToDictionary(dynamic dynObj)
        {
